...
if x =0
  then 
     ...
     insert into client values (new.id_client,null,new.nom,new.mdp,new.addresse,new.codeP,new.ville,new.pays
                          ,new.phone,new.mail,null);
end //
delimiter ;
...
while fini!=1
do
if datf is not null or datf<=curdate()
then

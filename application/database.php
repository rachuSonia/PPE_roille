...
function createconnection(){
    //$pdo=new PDO('mysql:host=localhost;dbname=roille;charset=utf8','sonia','sonia');
    $pdo=new PDO('mysql:host=localhost;dbname=roilleun;charset=utf8','root','');
...
function addCommande($quantite_com,$idProduit,$dateDebut,$dateFin,$id_client){
    ...
    $req=$pdo->prepare("INSERT INTO detail_com (quantite_com,id_produit,dateD,dateF,id_client) 
                        values (:quantite_com,:id_produit,:dateD,:dateF,:id)");
    $req->execute(array(
